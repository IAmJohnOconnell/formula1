//Circuit Photos
import abudhabi from "../assets/circuits/simple/abudhabi_simple.avif";
import australia from "../assets/circuits/simple/australia_simple.png";
import austria from "../assets/circuits/simple/austria_simple.avif";
import azerbaijan from "../assets/circuits/simple/azerbaijan_simple.avif";
import bahrain from "../assets/circuits/simple/bahrain_simple.avif";
import belgium from "../assets/circuits/simple/belgium_simple.avif";
import brazil from "../assets/circuits/simple/brazil_simple.avif";
import canada from "../assets/circuits/simple/canada_simple.avif";
import china from "../assets/circuits/simple/china_simple.png";
import emiliaromagna from "../assets/circuits/simple/emiliaromagna_simple.avif";
import uk from "../assets/circuits/simple/uk_simple.avif";
import hungary from "../assets/circuits/simple/hungary_simple.avif";
import italy from "../assets/circuits/simple/italy_simple.avif";
import japan from "../assets/circuits/simple/japan_simple.avif";
import lasvegas from "../assets/circuits/simple/lasvegas_simple.avif";
import mexico from "../assets/circuits/simple/mexico_simple.avif";
import miami from "../assets/circuits/simple/miami_simple.avif";
import monaco from "../assets/circuits/simple/monaco_simple.avif";
import netherlands from "../assets/circuits/simple/netherlands_simple.avif";
import qatar from "../assets/circuits/simple/qatar_simple.avif";
import saudiarabia from "../assets/circuits/simple/saudiarabia_simple.avif";
import singapore from "../assets/circuits/simple/singapore_simple.avif";
import spain from "../assets/circuits/simple/spain_simple.avif";
import usa from "../assets/circuits/simple/usa_simple.avif";

//Track Layouts
import abudhabi_layout from "../assets/circuits/abudhabi_track.avif";
import australia_layout from "../assets/circuits/australia_track.avif";
import austria_layout from "../assets/circuits/austria_track.avif";
import azerbaijan_layout from "../assets/circuits/azerbaijan_track.avif";
import bahrain_layout from "../assets/circuits/bahrain_track.avif";
import belgium_layout from "../assets/circuits/belgium_track.png";
import brazil_layout from "../assets/circuits/brazil_track.avif";
import canada_layout from "../assets/circuits/canada_track.avif";
import china_layout from "../assets/circuits/china_track.png";
import emiliaromagna_layout from "../assets/circuits/emiliaromagna_track.avif";
import uk_layout from "../assets/circuits/uk_track.avif";
import hungary_layout from "../assets/circuits/hungary_track.avif";
import italy_layout from "../assets/circuits/italy_track.avif";
import japan_layout from "../assets/circuits/japan_track.avif";
import lasvegas_layout from "../assets/circuits/lasvegas_track.avif";
import mexico_layout from "../assets/circuits/mexico_track.avif";
import miami_layout from "../assets/circuits/miami_track.avif";
import monaco_layout from "../assets/circuits/monaco_track.avif";
import netherlands_layout from "../assets/circuits/netherlands_track.avif";
import qatar_layout from "../assets/circuits/qatar_track.avif";
import saudiarabia_layout from "../assets/circuits/saudiarabia_track.avif";
import singapore_layout from "../assets/circuits/singapore_track.avif";
import spain_layout from "../assets/circuits/spain_track.avif";
import usa_layout from "../assets/circuits/usa_track.avif";

// Team Logos
import redbull from "../assets/teams/redbull_logo.avif";
import ferrari from "../assets/teams/ferrari_logo.avif";
import mercedes from "../assets/teams/mercedes_logo.avif";
import mclaren from "../assets/teams/mclaren_logo.avif";
import alpinef1team from "../assets/teams/alpinef1team.avif";
import rbf1team from "../assets/teams/racingbulls_logo.avif";
import sauber from "../assets/teams/kicksauber_logo.avif";
import astonmartin from "../assets/teams/astonmartin_logo.avif";
import williams from "../assets/teams/williams_logo.avif";
import haasf1team from "../assets/teams/haas_logo.avif";

//Team cars
import redbull_car from "../assets/teams/cars/redbull_logo.avif";
import ferrari_car from "../assets/teams/cars/ferrari_logo.avif";
import mercedes_car from "../assets/teams/cars/mercedes_logo.avif";
import mclaren_car from "../assets/teams/cars/mclaren_logo.avif";
import alpinef1team_car from "../assets/teams/cars/alpinef1team.avif";
import rbf1team_car from "../assets/teams/cars/racingbulls_logo.avif";
import sauber_car from "../assets/teams/cars/kicksauber_logo.avif";
import astonmartin_car from "../assets/teams/cars/astonmartin_logo.avif";
import williams_car from "../assets/teams/cars/williams_logo.avif";
import haasf1team_car from "../assets/teams/cars/haas_logo.avif";

// Driver Photos
import maxverstappen from "../assets/drivers/maxverstappen.avif";
import charlesleclerc from "../assets/drivers/charlesleclerc.avif";
import carlossainz from "../assets/drivers/carlossainz.avif";
import lewishamilton from "../assets/drivers/lewishamilton.avif";
import fernandoalonso from "../assets/drivers/fernandoalonso.avif";
import lancestroll from "../assets/drivers/lancestroll.avif";
import georgerussell from "../assets/drivers/georgerussell.avif";
import estebanocon from "../assets/drivers/estebanocon.avif";
import landonorris from "../assets/drivers/landonorris.avif";
import alexanderalbon from "../assets/drivers/alexalbon.avif";
import pierregasly from "../assets/drivers/pierregasly.avif";
import yukitsunoda from "../assets/drivers/yukitsunoda.avif";
import nicohulkenberg from "../assets/drivers/nicohulkenberg.avif";
import oscarpiastri from "../assets/drivers/oscarpiastri.avif";
import liamlawson from "../assets/drivers/liamlawson.avif";
import isackhadjar from "../assets/drivers/isackhadjar.avif";
...
import spain_flag from "../assets/flags/Spain.avif";
import monaco_flag from "../assets/flags/Monaco.avif";
import azerbaijan_flag from "../assets/flags/Azerbaijan.avif";
import canada_flag from "../assets/flags/Canada.avif";
import austria_flag from "../assets/flags/Austria.avif";
import uk_flag from "../assets/flags/Unitedkingdom.avif";
import uae_flag from "../assets/flags/UAE.avif";
import hungary_flag from "../assets/flags/Hungary.avif";
import belgium_flag from "../assets/flags/Belgium.avif";
import italy_flag from "../assets/flags/Italy.avif";
import singapore_flag from "../assets/flags/Singapore.avif";
import japan_flag from "../assets/flags/Japan.avif";
import usa_flag from "../assets/flags/UnitedStates.avif";
import mexico_flag from "../assets/flags/Mexico.avif";
import saudiarabia_flag from "../assets/flags/SaudiArabia.avif";
import qatar_flag from "../assets/flags/Qatar.avif";
import brazil_flag from "../assets/flags/Brazil.avif";
import france_flag from "../assets/flags/France.avif";
import germany_flag from "../assets/flags/Germany.avif";
import thailand_flag from "../assets/flags/Thailand.avif";
import Newzealand_flag from "../assets/flags/Newzealand.avif";

// Create Map fn's
const createDriverFlagMap = (photos) => {
  if (!photos || !photos.flag) {
    console.warn("Photos object is missing or does not have flag property");
    return {};
  }
  ...
  return {
    ...
    French: photos.flag.france_flag,
    German: photos.flag.germany_flag,
    Italian: photos.flag.italy_flag,
    Japanese: photos.flag.japan_flag,
    Monegasque: photos.flag.monaco_flag,
    Dutch: photos.flag.netherlands_flag,
    Spanish: photos.flag.spain_flag,
    British: photos.flag.uk_flag,
    Australian: photos.flag.australia_flag,
    NewZealander: photos.flag.Newzealand_flag,
  };
};

const createCircuitMapping = () => {
  return {
    australia: {
      circuitKey: "australia",
      flagKey: "australia",
    },
    bahrain: {
      circuitKey: "bahrain",
...
export const getDriverFlag = (photos, nationality) => {
  if (!nationality) {
    console.warn("Location country not provided");
    return null;
  }
  const normalizedNationality = nationality.split(" ").join("");

  const flagMap = createDriverFlagMap(photos);
  return flagMap[normalizedNationality] || null;
};

export const getCircuitPhoto = (photos, locationCountry) => {
  if (!locationCountry) {
    console.warn("Location country not provided");
    return null;
  }

  const normalizedCountry = locationCountry
    .replace("grand prix", "")
    .toLowerCase()
    .split(" ")
    .join("");

  const circuitMap = createCircuitMapping();

  if (!circuitMap[normalizedCountry]) {
    console.warn(`No mapping found for country: ${normalizedCountry}`);
    return null;
  }

  const circuitKey = circuitMap[normalizedCountry].circuitKey;
  const circuitPhoto = photos.circuit[circuitKey];

  if (!circuitPhoto) {
    console.warn(`No photo found for ${circuitKey}`);
    return null;
  }
...
export const getTrackLayout = (photos, locationCountry) => {
  if (!locationCountry) {
    console.warn("Location country not provided");
    return null;
  }
  ...
  const circuitKey = circuitMap[normalizedCountry].circuitKey;
  const circuitPhoto = photos.trackLayout[`${circuitKey}_layout`];
...
export const getCircuitFlag = (photos, locationCountry) => {
  if (!locationCountry) {
    console.warn("Location country not provided");
    return null;
  }
  ...
  const flagKey = circuitMap[normalizedCountry].flagKey;
  const flagPhoto = photos.flag[`${flagKey}_flag`];

  if (!flagPhoto) {
    console.log("Available flags:", Object.keys(photos.flag));
    console.warn(`No flag found for circuit ${flagKey}`);
    return null;
  }
...
export const getTeamColor = (constructor) => {
  const teamColors = {
    McLaren: "#FF9800",
    Ferrari: "#DC0000",
    Mercedes: "#27f4d2",
...
export const getTrackInfo = (locationCountry) => {
  if (!locationCountry) {
    console.warn("Location country not provided");
    return null;
  }
  ...
  let selectedTrackInfo = trackInfo[normalizedCountry];

  if (!selectedTrackInfo) {
    console.log(`Could not find track info for ${normalizedCountry}`);
    console.warn(`Available trackInfo`, Object.keys(trackInfo));
  }
  return selectedTrackInfo;
};

export const getDriverBios = (driverName) => {
  let bios = {
    norris: `Lando Norris may not be named after Star Wars rebel Lando Calrissian - his Mum just liked the moniker - but he has flair and fighting spirit in bountiful supply.
...
Indeed, that drive helped him secure a full-time F1 seat with the Ferrari-powered Haas squad for 2025 – as well as an early Grand Prix debut with them in Azerbaijan ’24, as team regular Kevin Magnussen served out a one-race ban.`,
    tsunoda: `In the entire history of Formula 1, no Japanese driver has ever won a World Championship Grand Prix. Could Yuki Tsunoda be the first? Red Bull certainly think so, with the youngster very much on the path to their senior team if he continues to impress as he has done over the past few years.
...
He may not have adapted to Grand Prix racing quite as quickly as he did to F2, but with four seasons now under his belt, Tsunoda has firmly established himself in Formula 1 - and as Racing Bull's defacto team leader.`,
...
It is never easy living in the shadow of sporting giants, but Sainz has shown the drive and disposition to deal with it, scoring four Grand Prix victories during his time with Scuderia seasons before moving to his latest challenge at Williams. Vamos!`,
    hadjar: `Isack Hadjar was the final driver to be announced for the 2025 season after Red Bull’s dramatic winter reshuffle, which involved Liam Lawson replacing Sergio Perez and the French-Algerian picking up the vacant seat at Racing Bulls.
